...
public class ZebedeeBTCPay : MonoBehaviour
{
    ...
    private ZbdBtcpayClient btcPayClient = null;
    ...
    public void Start()
    {
        ...
        btcPayClient = new ZbdBtcpayClient(this, pairCode, btcpayServerHost);

        StartCoroutine(btcPayClient.Intitalize());
    }
    ...
    public void CreateInvoice()
    {
        ...
        InvoiceBtcpay invoice = new InvoiceBtcpay(double.Parse(amount.text), curr);//金額と通貨
    ...
    private void handleInvoice(InvoiceBtcpay invoice)
    {
